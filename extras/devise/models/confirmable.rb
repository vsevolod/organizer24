# REWRITE DEVISE CONFIRMABLE FOR SENDING SMS METHODS
  ...
  module Models
    ...
    module Confirmable
      ...
      def self.required_fields(klass)
        required_methods = [:confirmation_number, :confirmed_at, :confirmation_sent_at]
      ...
      def send_confirmation_instructions
        self.confirmation_number = nil if reconfirmation_required?
      ...
      def resend_confirmation_token
        pending_any_confirmation do
          self.confirmation_number = nil if confirmation_period_expired?
      ...
      def confirmation_period_expired?
        self.class.allow_unconfirmed_access_for && (Time.zone.now > confirmation_sent_at + self.class.allow_unconfirmed_access_for)
      end
      ...
      def pending_any_confirmation
        if !confirmed? || pending_reconfirmation?
          ...
          errors.add(:phone, :already_confirmed)
          false
        end
      end
      ...
      def generate_confirmation_token
        self.confirmation_number = Random.new.rand(100_000..999_999) # self.class.confirmation_token
      ...
      module ClassMethods
        ...
        def send_confirmation_instructions(attributes = {})
          confirmable = find_by(unconfirmed_email_with_errors: attributes) if reconfirmable
