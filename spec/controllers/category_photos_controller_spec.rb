...
describe CategoryPhotosController do
  ...
  describe "POST create" do
    ...
    it 'should create category_photo' do
      expect {
        post :create, category_photo: valid_attributes
      }.to change(CategoryPhoto, :count).by(1)
    end

    it 'should not create category_photo' do
      expect {
        post :create, category_photo: invalid_attributes
      }.not_to change(CategoryPhoto, :count).by(1)
    end
  end
  ...
  describe "PUT update" do
    ...
    it 'should change name for categry_photo' do
      ...
      expect {
        put :update, id: category_photo.id, category_photo: {name: new_name }
      }.to change{category_photo.reload.name}.to(new_name)
    end
  end
  ...
  describe "DELETE destroy" do
    ...
    it 'should destroy categry_photo' do
      expect {
        delete :destroy, id: category_photo.id
      }.to change(CategoryPhoto, :count).by(-1)
    end
  end
