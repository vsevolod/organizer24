...
describe PhotosController do
  ...
  describe 'POST create' do
    ...
    it 'should create photo' do
      expect do
        post :create, params: { photo: valid_attributes, category_photo_id: category_photo.id, format: 'js' }
  ...
  describe 'DELETE destroy' do
    it 'should destroy category_photo' do
      expect do
        delete :destroy, params: { id: photo.id, category_photo_id: category_photo.id, format: 'js' }
      end.to change(Photo, :count).by(-1)
    end
  end
end
