...
(function ($) {
    $.fn.piroBox_ext = function (opt) {
        ...
        var struct = ('<div class="piro_overlay"></div>' + '<table class="piro_html"  cellpadding="0" cellspacing="0">' + '<tr>' + '<td class="h_t_l"></td>' + '<td class="h_t_c" title="drag me!!"></td>' + '<td class="h_t_r"></td>' + '</tr>' + '<tr>' + '<td class="h_c_l"></td>' + '<td class="h_c_c">' + '<div class="piro_loader" title="close"><span></span></div>' + '<div class="resize">' + '<div class="nav_container">' + '<a href="#prev" class="piro_prev" title="previous"><i class="fa fa-angle-left"></i></a>' + '<a href="#next" class="piro_next" title="next"><i class="fa fa-angle-right"></i></a>' + '<div class="piro_prev_fake"><i class="fa fa-angle-left"></i></div>' + '<div class="piro_next_fake"><i class="fa fa-angle-right"></i></div>' + '<div class="piro_close" title="close"></div>' + '</div>' + '<div class="caption"></div>' + '<div class="div_reg"></div>' + '</div>' + '</td>' + '<td class="h_c_r"></td>' + '</tr>' + '<tr>' + '<td class="h_b_l"></td>' + '<td class="h_b_c"></td>' + '<td class="h_b_r"></td>' + '</tr>' + '</table>');
        $('body').append(struct);
