...
!function ($) {
    ...
    DRPGlobal.template =
	'<div class="spinedit">' +
	'<span class="icon-chevron-up"><i alt="" class="tooltips icon" title="Increase">&#61736</i></span>' +
	'<span class="icon-chevron-down"><i alt="" class="tooltips icon" title="Decrease">&#61701</i></span>' +
	'</div>';
